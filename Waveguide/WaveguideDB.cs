...
namespace Waveguide
{
    public class WaveguideDB
    {
        ...
        public ObservableCollection<AnalysisValueContainer> m_analysisValueList;
        ...
        public WaveguideDB()
        {
            ...
            m_analysisValueList = new ObservableCollection<AnalysisValueContainer>();
                ...
                using (SqlCommand command = new SqlCommand("SELECT * FROM ColorModel", con))
                {
                    ...
                    try
                    {
                        ...
                        while (reader.Read())
                        {
                            ...
                            cmContainer.MaxPixelValue = 16383; // later set by image to be displayed
                ...
                using (SqlCommand command = new SqlCommand("SELECT * FROM ExperimentImage", con))
                {
                    ...
                    try
                    {
                        ...
                        while (reader.Read())
                        {
                            ...
                            cont.ExperimentIndicatorID = reader.GetInt32(6);
                            cont.MSecs = reader.GetInt32(7);
                            cont.Exposure = reader.GetInt32(8);
                            cont.NumBytes = reader.GetInt32(9);
                            cont.MaxPixelValue = reader.GetInt32(10);
                            cont.CompressionAlgorithm = (COMPRESSION_ALGORITHM)reader.GetInt32(11);
                ...
                using (SqlCommand command = new SqlCommand("SELECT * FROM ExperimentImage WHERE ExperimentImageID=@p1", con))
                {
                    ...
                    try
                    {
                        ...
                        while (reader.Read())
                        {
                            ...
                            expImage.Width = reader.GetInt32(1);
                            expImage.Height = reader.GetInt32(2);
                            expImage.Depth = reader.GetInt32(3);

                            expImage.TimeStamp = reader.GetDateTime(5);
                            expImage.ExperimentIndicatorID = reader.GetInt32(6);
                            expImage.MSecs = reader.GetInt32(7);
                            expImage.Exposure = reader.GetInt32(8);
                            expImage.NumBytes = reader.GetInt32(9);
                            expImage.MaxPixelValue = reader.GetInt32(10);

                            
                            byte[] buffer = new byte[expImage.NumBytes];
                            buffer = (byte[])reader["ImageData"];

                            ushort[] decompressedImage;
                            if (DecompressImage(expImage.CompressionAlgorithm, buffer, out decompressedImage))
                            {
                                expImage.ImageData = decompressedImage;
                                expImage.NumBytes = expImage.ImageData.Length * expImage.Depth;
                            }
                        }
                    }
                    catch (Exception e)
        ...
        public bool InsertExperimentImage(ref ExperimentImageContainer expImage)
        {
            ...
            using (SqlConnection con = new SqlConnection(m_connectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand("INSERT INTO ExperimentImage (Width,Height,Depth,ImageData,TimeStamp,ExperimentIndicatorID,MSecs,Exposure,NumBytes,MaxPixelValue,CompressionAlgorithm) "
                                                            ...
                                                            , con))
                {
                    ...
                    {
                        byte[] imageBuffer;
                        CompressImage(expImage.CompressionAlgorithm, expImage.ImageData, out imageBuffer);

                        command.Parameters.AddWithValue("@p1", expImage.Width);
                        command.Parameters.AddWithValue("@p2", expImage.Height);
                        command.Parameters.AddWithValue("@p3", expImage.Depth);
                        ...
                        command.Parameters.AddWithValue("@p6", expImage.ExperimentIndicatorID);
                        command.Parameters.AddWithValue("@p7", expImage.MSecs);
                        command.Parameters.AddWithValue("@p8", expImage.Exposure);
                        command.Parameters.AddWithValue("@p9", imageBuffer.Length);
                        command.Parameters.AddWithValue("@p10", expImage.MaxPixelValue);
                        command.Parameters.AddWithValue("@p11", (int)expImage.CompressionAlgorithm);
        ...
        public bool UpdateExperimentImage(ExperimentImageContainer expImage)
        {
            bool success = true;
            ...
            using (SqlConnection con = new SqlConnection(m_connectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand("UPDATE ExperimentImage SET Width=@p1,Height=@p2,Depth=@p3,ImageData=@p4,TimeStamp=@p5," + 
                                                            "ExperimentIndicatorID=@p6,MSecs=@p7,Exposure=@p8,NumBytes=@p9,MaxPixelValue=@p10,CompressionAlgorithm=@p11 " +
                                                            "WHERE ExperimentImageID=@p12", con))
                {
                    try
                    {
                        byte[] imageBuffer;
                        ...
                        command.Parameters.AddWithValue("@p10", expImage.MaxPixelValue);
                        command.Parameters.AddWithValue("@p11", (int)expImage.CompressionAlgorithm);
                        command.Parameters.AddWithValue("@p12", expImage.ExperimentImageID);
        ...
        public bool InsertReferenceImage(ref ReferenceImageContainer refImage)
        {
            ...
            using (SqlConnection con = new SqlConnection(m_connectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand("INSERT INTO ReferenceImage (Width,Height,Depth,ImageData,TimeStamp,NumBytes,MaxPixelValue,CompressionAlgorithm,Description) "
        ...
        public bool UpdateReferenceImage(ReferenceImageContainer refImage)
        {
            ...
            using (SqlConnection con = new SqlConnection(m_connectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand("UPDATE ReferenceImage SET Width=@p1,Height=@p2,Depth=@p3,ImageData=@p4,TimeStamp=@p5,NumBytes=@p6,MaxPixelValue=@p7,CompressionAlgorithm=@p8,Description=@p9 " +                            
                                                            "WHERE ReferenceImageID=@p10", con))
                {
                    try
                    {
                        byte[] imageBuffer;
                        ...
                        command.Parameters.AddWithValue("@p10", refImage.ReferenceImageID);
        ...
        public bool InsertExperimentIndicator(ref ExperimentIndicatorContainer indicator)
        {
            ...
            using (SqlConnection con = new SqlConnection(m_connectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand("INSERT INTO ExperimentIndicator (ExperimentID,ExcitationFilterDesc,EmissionFilterDesc,ExcitationFilterPos,EmissionFilterPos,MaskID,Exposure,Gain,Description,SignalType) "
        ...
        public bool UpdateExperimentIndicator(ExperimentIndicatorContainer indicator)
        {
            ...
            using (SqlConnection con = new SqlConnection(m_connectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand("UPDATE ExperimentIndicator SET ExperimentID=@p1,ExcitationFilterDesc=@p2,EmissionFilterDesc=@p3,ExcitationFilterPos=@p4," +
                                                           "EmissionFilterPos=@p5,MaskID=@p6,Exposure=@p7,Gain=@p8,Description=@p9,SignalType=@p10 " +
                                                            "WHERE ExperimentIndicatorID=@p11", con))
                {
                    try
                    {
                        command.Parameters.AddWithValue("@p1", indicator.ExperimentID);
                        ...
                        command.Parameters.AddWithValue("@p9", indicator.Description);
                        command.Parameters.AddWithValue("@p10", (int)indicator.SignalType);
                        command.Parameters.AddWithValue("@p11", indicator.ExperimentIndicatorID);                        
        ...
        public bool GetAnalysis(int analysisID, out AnalysisContainer analysis)
        {
            ...
            using (SqlConnection con = new SqlConnection(m_connectionString))
            {
                ...
                // go get the analysis values for this analysis,  values are stored in m_analysisValueList
                success = GetAllAnalysisValuesForAnalysis(analysisID);
        ...
        public bool InsertAnalysis(ref AnalysisContainer analysis)
        {
            ...
            using (SqlConnection con = new SqlConnection(m_connectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand("INSERT INTO Analysis (ExperimentIndicatorID,Description,TimeStamp) "
        ...
        public bool UpdateAnalysis(AnalysisContainer analysis)
        {
            ...
            using (SqlConnection con = new SqlConnection(m_connectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand("UPDATE Analysis SET ExperimentIndicatorID=@p1,Description=@p2,TimeStamp=@p3 " +
                                                            "WHERE AnalysisID=@p4", con))
                {
                    try
                    {
                        command.Parameters.AddWithValue("@p1", analysis.ExperimentIndicatorID);
                        ...
                        command.Parameters.AddWithValue("@p4", analysis.AnalysisID);
        ...
        public bool DeleteAnalysis(int analysisID)
        {
            ...
            success = DeleteAllAnalysisValuesForAnalysis(analysisID);
        ...
        public bool GetAllAnalysisValuesForAnalysis(int analysisID)
        {
            bool success = true;

            m_analysisValueList.Clear();

            using (SqlConnection con = new SqlConnection(m_connectionString))
            {
                con.Open();

                using (SqlCommand command = new SqlCommand("SELECT * FROM AnalysisValue WHERE AnalysisID=@p1", con))
                {
                    command.Parameters.Add("@p1", System.Data.SqlDbType.Int).Value = analysisID;
                    ...
                    try
                    {
                        ...
                        while (reader.Read())
                        {
                            AnalysisValueContainer cont = new AnalysisValueContainer();

                            cont.AnalysisValueID = reader.GetInt32(0);
                            cont.AnalysisID = reader.GetInt32(1);
                            cont.Row = reader.GetInt32(2);
                            cont.Col = reader.GetInt32(3);
                            cont.SequenceNumber = reader.GetInt32(4);
                            cont.Value = reader.GetFloat(5);

                            m_analysisValueList.Add(cont);
                        }
                    }
                    catch (Exception e)
                    {
        ...
        public bool GetAnalysisValue(int analysisValueID, out AnalysisValueContainer analysisValue)
        {
            bool success = true;
            ...
            using (SqlConnection con = new SqlConnection(m_connectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand("SELECT * FROM AnalysisValue WHERE AnalysisValueID=@p1", con))
                {
                    command.Parameters.Add("@p1", System.Data.SqlDbType.Int).Value = analysisValueID;
                    ...
                    try
                    {
                        ...
                        while (reader.Read())
                        {
                            analysisValue = new AnalysisValueContainer();

                            analysisValue.AnalysisValueID = reader.GetInt32(0);
                            analysisValue.AnalysisID = reader.GetInt32(1);
                            analysisValue.Row = reader.GetInt32(2);
                            analysisValue.Col = reader.GetInt32(3);
                            analysisValue.SequenceNumber = reader.GetInt32(4);
                            analysisValue.Value = reader.GetFloat(5);
                        }
                    }
                    catch (Exception e)
                    {
        ...
        public bool InsertAnalysisValue(ref AnalysisValueContainer analysisValue)
        {
            bool success = true;
            ...
            using (SqlConnection con = new SqlConnection(m_connectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand("INSERT INTO AnalysisValue (AnalysisID,Row,Col,SequenceNumber,Value) "
                                                            + "OUTPUT INSERTED.AnalysisValueID "
                                                            + "VALUES(@p1,@p2,@p3,@p4,@p5)"
                                                            , con))
                {
                    try
                    {
                        command.Parameters.AddWithValue("@p1", analysisValue.AnalysisID);
                        command.Parameters.AddWithValue("@p2", analysisValue.Row);
                        command.Parameters.AddWithValue("@p3", analysisValue.Col);
                        command.Parameters.AddWithValue("@p4", analysisValue.SequenceNumber);
                        command.Parameters.AddWithValue("@p5", analysisValue.Value);

                        analysisValue.AnalysisValueID = (int)command.ExecuteScalar();
                    }
                    catch (Exception e)
                    {
                        lastErrMsg = e.Message;
        ...
        public bool InsertAnalysisValues(int analysisID, int sequenceNumber, float[,] data)
        {
            bool success = true;
                ...
                for (int r = 0; r < rows; r++)
                    for (int c = 0; c < cols; c++ )
                                                                    ...
                                                                    , con))
                        {
                            ...
                            {
                                command.Parameters.AddWithValue("@p1", analysisID);
                                command.Parameters.AddWithValue("@p2", r);
                                command.Parameters.AddWithValue("@p3", c);
                                command.Parameters.AddWithValue("@p4", sequenceNumber);
                                command.Parameters.AddWithValue("@p5", data[r,c]);

                                int analysisValueID = (int)command.ExecuteScalar();
                            }
                            catch (Exception e)
                            {
                                lastErrMsg = e.Message;
        ...
        public bool UpdateAnalysisValue(AnalysisValueContainer analysisValue)
        {
            bool success = true;
            ...
            using (SqlConnection con = new SqlConnection(m_connectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand("UPDATE AnalysisValue SET AnalysisID=@p1,Row=@p2,Col=@p3,SequenceNumber=@p4,Value=@p5 " +
                                                            "WHERE AnalysisValueID=@p6", con))
                {
                    try
                    {
                        command.Parameters.AddWithValue("@p1", analysisValue.AnalysisID);
                        ...
                        command.Parameters.AddWithValue("@p6", analysisValue.AnalysisValueID);
        ...
        public bool DeleteAnalysisValue(int analysisValueID)
        {
            bool success = true;
            ...
            using (SqlConnection con = new SqlConnection(m_connectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand("DELETE FROM AnalysisValue WHERE AnalysisValueID=@p1", con))
                {
                    try
                    {
                        command.Parameters.AddWithValue("@p1", analysisValueID);
        ...
        public bool DeleteAllAnalysisValuesForAnalysis(int analysisID)
        {
            bool success = true;
            ...
            using (SqlConnection con = new SqlConnection(m_connectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand("DELETE FROM AnalysisValue WHERE AnalysisID=@p1", con))
                {
                    try
                    {
                        command.Parameters.AddWithValue("@p1", analysisID);
